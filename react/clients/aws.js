  ...
  try {
    switch (event.routeKey) {
        ...
        case "PUT /apiAcctLead/{uuid}":
          ...
          break;
      case "POST /apiAcctLead/{uuid}/actions/convert":
        //Busca Lead por UUID
